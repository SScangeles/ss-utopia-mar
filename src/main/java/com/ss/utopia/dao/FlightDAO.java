...
public class FlightDAO extends BaseDAO<Flight> {
	...
	public List<Flight> getFlightByUserID(Integer userID) throws SQLException {
		return readData("select \r\n"
				+ "flight.id as flight_id,\r\n"
				+ "flight.*,\r\n"
				+ "rt.destination_id,\r\n"
				...
				+ "on a.type_id = a_t.id\r\n"
				+ "inner join\r\n"
				+ "(select * from booking_user) b_u\r\n"
				+ "on b_u.user_id = ?\r\n"
				+ "inner join\r\n"
				+ "(select * from flight_bookings) as f_b\r\n"
				+ "on flight.id = f_b.flight_id and f_b.booking_id = b_u.booking_id;", new Object[] {userID});
	}
